...
* `gulp` The default task will compile the LESS and JS into the `dest` directory and minify the output, and it will copy all vendor libraries from `bower_components` into the `vendor` directory
